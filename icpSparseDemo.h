...
public:
  ...
  */
  void run()
  {
    ...
    cout << "Resulting PC is in media/bunny_ICP_test.ply" << endl;
    ...
    nbIterations = 30;     //Number of iterations for the algorithm
    nbIterationsIn = 10;    //Number of iterations for the step 2 of the algorithm 
    ...
    cout << "Resulting PC is in media/bunny_noised_ICP.ply" << endl;
